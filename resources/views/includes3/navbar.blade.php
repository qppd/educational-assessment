      ...
      <li class="nav-item dropdown user-menu">
          ...
          <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              ...
              <li class="user-header">
                  <img src="{{ url('' . session('photo')) }}" class="img-circle elevation-2" alt="Professor">
              ...
              Settings</a>
               --}}
                  ...
                  <a href="/faculty/logout" class="btn btn-default btn-flat float-right">Log out</a>
              </li>
          </ul>
      </li>
...
@include('includes3/modal_password')
