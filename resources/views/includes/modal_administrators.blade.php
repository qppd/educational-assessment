    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Sub Administrator | New</h4>
                ...
                <form class="form-horizontal" method="POST" action="/admin/administrator/add"
                    ...
                    <div class="card" style="width:100%;">
                        ...
                        <div class="card-body">
                            ...
                            <p>Select a photo of new sub administrator.</p>

                            <div class="form-group">
                                <label for="photo" class="col-sm-3 control-label">Photo</label>

                                <div class="col-xs-3">
                                    <img class="box-style" src="{{ url('images/administrators/administrator.jpg') }}"
                            ...
                            <br>
                            <p>Fill sub administrator's personal information below.</p>
                            <div class="row">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="administrator/edit"
                    enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card" style="width:100%;">
                        ...
                        <div class="card-body">
                            ...
                            <p>Select a photo of the administrator. Do not upload any file if you don't want to change
                                it.</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-3">
                                    <img class="box-style" src="" id="edit_administrator_photo"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            <input type="text" class="form-control" id="edit_surname"
                                                name="surname" placeholder="Ex: Dela Cruz"
                                                oninput="this.value = this.value.replace(/[^A-Z a-z ]/g, '');"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            <input type="text" class="form-control" id="edit_contact"
                                                name="contact" placeholder="Ex: 09634905586" maxlength="11"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            <input type="email" class="form-control" id="edit_email"
                                                name="email" placeholder="Ex: john@gmail.com" required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br>
                            <p>Choose administrator's account status.</p>
                            <div class="form-group">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="/admin/administrator/delete">
                    @csrf
