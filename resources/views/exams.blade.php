...
@include('includes3/modal_examinations')
...
<body class="hold-transition sidebar-mini layout-fixed">
                                        ...
                                        <tbody>
                                            @foreach ($examinations as $examination)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($examination['status'] == 'Pending')
                                                            <a href="/faculty/examinations/manage/{{ $examination['id'] }}"
                                                                class="btn bg-primary btn-sm" name = "examination_id"><i
                                                                    class="fas fa-search"></i>
                                                                View </a>

                                                            <button type="button" class="btn btn-success btn-sm upload"
                                                                data-id="{{ $examination['id'] }}"><i
                                                                    class="fas fa-upload"></i>
                                                                Upload Reviewer</button>

                                                            {{-- <a href="/faculty/examinations/upload/{{ $examination['id'] }}"
    ...
    <script>
        $(function() {
            ...
            $('#example2 tbody').on("click", ".upload", function() {
                $('#upload').modal('show');
                var id = $(this).data('id');
