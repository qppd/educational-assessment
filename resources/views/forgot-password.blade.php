...
<body>
    ...
    <div class="wrapper fadeInDown">
        ...
        <div id="formContent">
            ...
            <form action="/portal/forgot/password/update" method="POST" onsubmit="return validateForm()">
                @csrf
                ...
                <!-- Add error elements below each input field -->
                <input type="hidden" class="fadeIn second" id="username" name="username" placeholder="Student No."
                    required>
                <div id="usernameError" class="error"></div>

                <input type="hidden" id="student_email_address">
                <input type="hidden" class="fadeIn second" id="email" name="email" placeholder="Email Address"
                    required>
                <div id="emailError" class="error"></div>

                <input type="hidden" id="password" class="fadeIn third" name="ppassword" placeholder="New Password"
                    required>
                <div id="passwordError" class="error"></div>

                <input type="hidden" id="cpassword" class="fadeIn third" name="cpassword"
                    placeholder="Confirm Password" required>
                <div id="cpasswordError" class="error"></div>

                <input type="hidden" id="submit" class="fadeIn fourth" value="CHANGE PASSWORD">
                <a href="/portal" class="fadeIn fourth">Already have an account? Login now!</a>
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            if (userData) {
                                ...
                                document.getElementById('student_email_address')
                                    .value = userData
                                    .email;
...
<script>
    function validateForm() {
        var studentEmailAddress = document.getElementById('student_email_address').value;
        ...
        if (studentEmailAddress !== email) {
            document.getElementById('emailError').innerText =
                'Invalid email address! Please enter your account email address!';
            return false; // Prevent form submission
        }

        if (password !== cpassword) {
            document.getElementById('cpasswordError').innerText = 'Passwords do not match! Please try again!';
            return false; // Prevent form submission
        }

        // If the email addresses are the same, the form will be submitted
        return true;
    }
</script>
